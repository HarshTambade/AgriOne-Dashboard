...
import { Leaf, Mail, Lock, User, MapPin, Phone, ArrowLeft } from 'lucide-react';
  ...
  return (
    <div className="min-h-screen bg-gray-50 flex flex-col justify-center py-12 sm:px-6 lg:px-8">
      <div className="sm:mx-auto sm:w-full sm:max-w-md">
        ...
        <h2 className="mt-6 text-center text-3xl font-extrabold text-gray-900">AgriOne</h2>
        ...
        <div className="bg-white py-8 px-4 shadow sm:rounded-lg sm:px-10">
          ...
          <div className="mt-6 flex items-center justify-center">
            <div className="text-sm">
              ...
              <Link to="/login" className="font-medium text-green-600 hover:text-green-500 flex items-center">
